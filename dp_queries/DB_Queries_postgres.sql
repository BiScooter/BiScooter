...
ALTER TABLE STATION ADD COLUMN NO_BIKES INT;
ALTER TABLE STATION ADD COLUMN NO_STATIONS INT;
...
(
	...
	KICKOFF_STATION_ID		INT											REFERENCES STATION
																		ON DELETE CASCADE
																		ON UPDATE CASCADE,
...
UPDATE COMPLAINT SET RESPONSE ='SEEEEE' WHERE ID='3';